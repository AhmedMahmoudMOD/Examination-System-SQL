    ...
    public class ReportController : Controller
    {
        ...
        public IActionResult GenAsnwerReport(int stdid, int past_id)
        {
            ...
            if (data != null)
            {
                ...
                PdfFont font = new PdfStandardFont(PdfFontFamily.Courier, 25);
                //Draw the text.
                graphics.DrawString("Answers List", font, PdfBrushes.Black, new PointF(graphics.ClientSize.Width / 5, 100));
                ...
                string contentType = "application/pdf";
                //Define the file name.
                string fileName = "Answers Report.pdf";
                //Creates a FileContentResult object by using the file contents, content type, and file name.
                return File(stream, contentType, fileName);
        ...
        public IActionResult GenExamQuestionsReport(int examId)
        {
            var data = reportRepository.GenExamQuestionsReport(examId);
            if (data != null)
            {
                PdfDocument doc = new PdfDocument();
                //Add a page.
                ...
                pdfGrid.Columns[0].Width = 200;
                // Renaming Table Headers 
                PdfGridRow header = pdfGrid.Headers[0];

                header.Cells[0].Value = "Question Text";
                header.Cells[1].Value = "Choice 1";
                header.Cells[2].Value = "Choice 2";
                header.Cells[3].Value = "Choice 3";
                header.Cells[4].Value = "Choice 4";
                ...
                string contentType = "application/pdf";
                //Define the file name.
                string fileName = "Exam Questions Report.pdf";
                //Creates a FileContentResult object by using the file contents, content type, and file name.
                return File(stream, contentType, fileName);
